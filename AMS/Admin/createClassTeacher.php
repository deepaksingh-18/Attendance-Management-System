...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    value('$firstName','$lastName','$emailAddress','$classPassword','$phoneNo','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    emailAddress='$emailAddress', password='$classPassword',phoneNo='$phoneNo', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
...
<div class="col-xl-6">
    ...
    <select required name="classArmId" class="form-control mb-3" id="txtHint">
        <option value="">--Select Class Arm--</option>
        <!-- Class arms will be dynamically loaded here based on the selected class -->
    </select>
</div>
